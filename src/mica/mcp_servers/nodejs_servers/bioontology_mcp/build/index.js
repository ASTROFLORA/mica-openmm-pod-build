...
const isValidSearchTermsArgs = (args) => {
...
const isValidSearchPropertiesArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
        typeof args.query === 'string' &&
        (args.ontologies === undefined || typeof args.ontologies === 'string') &&
...
const isValidAnnotateTextArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidRecommendOntologiesArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidGetOntologyInfoArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidGetClassInfoArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidSearchOntologiesArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidGetAnalyticsArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
class BioOntologyServer {
        ...
        this.server.setRequestHandler(ReadResourceRequestSchema, async (request) => {
            ...
            if (ontologyMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch ontology ${acronym}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (classMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch class ${classId} from ${ontology}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (searchMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to search for "${query}": ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (annotationMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to annotate text: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (recommendationMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to get recommendations for "${input}": ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (analyticsMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch analytics for ${ontology}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
    ...
    async handleSearchTerms(args) {
        ...
        try {
            ...
            if (args.ontologies)
                params.ontologies = args.ontologies;
            if (args.require_exact_match !== undefined)
                params.require_exact_match = args.require_exact_match;
            if (args.suggest !== undefined)
                params.suggest = args.suggest;
            if (args.also_search_views !== undefined)
                params.also_search_views = args.also_search_views;
            if (args.require_definitions !== undefined)
                params.require_definitions = args.require_definitions;
            if (args.also_search_properties !== undefined)
                params.also_search_properties = args.also_search_properties;
            if (args.also_search_obsolete !== undefined)
                params.also_search_obsolete = args.also_search_obsolete;
            if (args.cui)
                params.cui = args.cui;
            if (args.semantic_types)
                params.semantic_types = args.semantic_types;
            if (args.include)
    ...
    async handleSearchProperties(args) {
        ...
        try {
            ...
            if (args.include)
                params.include = args.include;
            if (args.ontology_types)
                params.ontology_types = args.ontology_types;
    ...
    async handleSearchOntologies(args) {
        ...
        try {
            ...
            if (args.also_search_views !== undefined)
                params.also_search_views = args.also_search_views;
            if (args.include_views !== undefined)
                params.include_views = args.include_views;
            if (args.display_context !== undefined)
                params.display_context = args.display_context;
            if (args.display_links !== undefined)
    ...
    async handleGetOntologyInfo(args) {
    ...
    async handleAnnotateText(args) {
        ...
        try {
            ...
            if (args.semantic_types)
                params.semantic_types = args.semantic_types;
            if (args.expand_semantic_types_hierarchy !== undefined)
                params.expand_semantic_types_hierarchy = args.expand_semantic_types_hierarchy;
            if (args.expand_class_hierarchy !== undefined)
                params.expand_class_hierarchy = args.expand_class_hierarchy;
            if (args.class_hierarchy_max_level !== undefined)
                params.class_hierarchy_max_level = args.class_hierarchy_max_level;
            if (args.expand_mappings !== undefined)
                params.expand_mappings = args.expand_mappings;
            if (args.stop_words)
                params.stop_words = args.stop_words;
            if (args.minimum_match_length !== undefined)
                params.minimum_match_length = args.minimum_match_length;
            if (args.exclude_numbers !== undefined)
                params.exclude_numbers = args.exclude_numbers;
            if (args.whole_word_only !== undefined)
                params.whole_word_only = args.whole_word_only;
            if (args.exclude_synonyms !== undefined)
                params.exclude_synonyms = args.exclude_synonyms;
            if (args.longest_only !== undefined)
    ...
    async handleRecommendOntologies(args) {
        ...
        try {
            ...
            if (args.max_elements_set !== undefined)
                params.max_elements_set = args.max_elements_set;
            if (args.wc !== undefined)
                params.wc = args.wc;
    ...
    async handleBatchAnnotate(args) {
    ...
    async handleGetOntologyMetrics(args) {
        if (!args.ontology) {
